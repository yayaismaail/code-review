...
# 📖 CODE REVIEW OF MY PAST PROJECT TRIALS <a name="about-project"></a>

This repository is about learning how to:
...
```sh
git https://github.com/yayaismaail/code-review
```

then you will see the **Code-Review** on your system then type this:
...
Inside **code-review** you can see `index.html` file double click it
...
- **Comment on the reviewed codes**
- **Adds emojis and gifs**
- **Give a thorough feedback**
...
Feel free to check the [issues page](https://github.com/yayaismaail/code-review).
...
I would like to thanks the entire Microverse
